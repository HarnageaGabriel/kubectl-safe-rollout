...
func (d Readiness) Diagnose(_ context.Context, target Target) (Result, error) {
	...
	case "StatefulSet", "DaemonSet":
		...
		// for StatefulSet or DaemonSet (see ProgressDeadline's own Skip):
		// without this explicit Skip, Readiness would stay permanently,
		// silently empty for either kind, indistinguishable from "evaluated
		// every container and found none unready".
